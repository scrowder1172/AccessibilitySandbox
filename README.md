...
## Hacking With Swift project 15

This is Project 15 in Paul Hudson's 100 Days of SwiftUI course. The project demonstrates different accessibility enhancements that can be added to iOS apps so that all users can enjoy the app.
